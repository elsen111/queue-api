...
public class QueueController {
    ...
    @GetMapping
    @Operation(summary = "List all waiting customers, ordered by position")
    public ApiResponse<List<CustomerResponse>> getWaiting() {
        return ApiResponse.success(queueService.getWaitingCustomers());
    }
